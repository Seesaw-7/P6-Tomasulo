...
void multiplyMatrixRec(int row1, int col1, int A[3][100], int row2, int col2,
                       int B[3][100], int C[3][100]) {
...
void multiplyMatrix(int row1, int col1, int A[3][100], int row2, int col2,
                    int B[3][100]) {
  if (row2 != col1) {
    return;
  }
