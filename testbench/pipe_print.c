  ...
  if (!valid_inst)
    ...
    case 0x73:
      ...
      case 0b000:
        ...
        case 0x105:
          str = "wfi";
          break; // we just mostly care about this
        default:
          str = "system";
          break;
        }
...
void print_reg(int wb_reg_wr_data_out_hi, int wb_reg_wr_data_out_lo,
  ...
  if (wb_reg_wr_en_out)
    if ((wb_reg_wr_data_out_hi == 0) ||
      ...
      fprintf(ppfile, "r%d=0x%x%x  ", wb_reg_wr_idx_out, wb_reg_wr_data_out_hi,
              wb_reg_wr_data_out_lo);
}
...
void print_membus(int proc2mem_command, int mem2proc_response,
  ...
  case 1:
    fprintf(ppfile, "BUS_LOAD  MEM[");
    break;
  case 2:
    fprintf(ppfile, "BUS_STORE MEM[");
    break;
  default:
    return;
    break;
